        ...
        <div className="relative mt-20 border-b border-neutral-800 min-h-[800px]">
            ...
            <div className="flex flex-wrap mt-10 lg:mt-20">
                {features.map((feature, index)=>(
                    <div key={index} className="w-full sm:w-1/2 lg:w1/3">
                        <div className="flex">
                            <div className="flex items-center justify-center mx-6 h-10 w-10 p-2 bg-neutral-900 text-orange-700 rounded-full">
                                {feature.icon}
                            </div>
                            <div>
