    ...
    return (
        <div className="flex flex-col items-center mt-6 lg:mt-20">
            ...
            <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni in dolorem aliquam possimus quod hic inventore qui assumenda? Nobis porro minima fugit quisquam, corporis provident eligendi?
            </p>
